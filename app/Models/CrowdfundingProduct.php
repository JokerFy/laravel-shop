...
/*        if (Carbon::now() < $this->attributes['end_at'] && $value < 1) {
            return self::$statusMap[self::STATUS_FUNDING];
        }elseif ($value < 1){
            return self::$statusMap[self::STATUS_FAIL];
        }
        return self::$statusMap[self::STATUS_SUCCESS];*/
    }
